...
const TopLeftMenu: React.FC = (): React.ReactElement => {
	...
	return (
		<>
			...
			<div className="menu menu-topleft">
				<div className="menu-icon disabled" data-tip="Отменить" data-for="svgTooltip">
				...
				<div className="menu-icon" data-tip="Повторить" data-for="svgTooltip">
